...
class BuildOnpremApiClient : AzureDevOpsApiClient {
    ...
    [PSObject] GetTicketedArtifact([bool] $useTargetProject, [int] $buildId) {
        return $this.Request($useTargetProject, 'get', "public/build/builds/$buildId/ticketedartifacts", $this.apiVersion, $null)
    }

    # Gets a Zip file of the logs for a given build.
    [PSObject] GetTicketedLogs([bool] $useTargetProject, [int] $buildId) {
        return $this.Request($useTargetProject, 'get', "public/build/builds/$buildId/ticketedlogs", $this.apiVersion, $null)
    }
    ...
    [PSObject] ResetCounter([bool] $useTargetProject, [int] $definitionId) {
        return $this.Request($useTargetProject, 'post', "build/definitions/$definitionId", $this.apiVersion, $null)
    }
    ...
    [PSObject] DeleteFolder([bool] $useTargetProject, [string] $path) {
        return $this.Request($useTargetProject, 'delete', "build/folders/$path", $this.apiVersion, $null)
    }
