...
class WorkItemTrackingProcessApiClient : AzureDevOpsApiClient {
    ...
    [PSObject] GetSystemControls([bool] $useTargetProject, [string] $processId, [string] $witRefName) {
        return $this.Request($useTargetProject, 'get', "work/processes/$processId/workItemTypes/$witRefName/layout/systemcontrols", $this.apiVersion, $null)
    }

    # Deletes a system control modification on the work item form.
    [PSObject] DeleteSystemControl([bool] $useTargetProject, [string] $processId, [string] $witRefName, [string] $controlId) {
        return $this.Request($useTargetProject, 'delete', "work/processes/$processId/workItemTypes/$witRefName/layout/systemcontrols/$controlId", $this.apiVersion, $null)
    }
     # Updates/adds a system control on the work item form.
    [PSObject] UpdateSystemControl([bool] $useTargetProject, [PSObject] $body, [string] $processId, [string] $witRefName, [string] $controlId) {
        return $this.Request($useTargetProject, 'patch', "work/processes/$processId/workItemTypes/$witRefName/layout/systemcontrols/$controlId", $this.apiVersion, $body)
    }
