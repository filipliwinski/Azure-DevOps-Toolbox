...
class CoreApiClient : AzureDevOpsApiClient {
    ...
    # CoreApiClient([string] $serviceHost, [string] $organization, [string] $projectName, [string] $personalAccessToken)
    #     : base ($serviceHost, $organization, $projectName, $personalAccessToken, $serviceHost, $organization, $projectName, $personalAccessToken) {}

    CoreApiClient([string] $sourceServiceHost, [string] $sourceOrganization, [string] $sourceProjectName, [string] $sourcePersonalAccessToken, [string] $targetServiceHost, [string] $targetOrganization, [string] $targetProjectName, [string] $targetPersonalAccessToken)
    ...
    [PSObject] GetProjectTeamsByCategory([bool] $useTargetProject, [string] $projectId) {
        return $this.Request($useTargetProject, 'get', "projects/Id/categorizedteams/", $this.apiVersion, $null)
    }
