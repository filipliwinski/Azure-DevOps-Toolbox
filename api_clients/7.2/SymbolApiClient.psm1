...
class SymbolApiClient : AzureDevOpsApiClient {
    ...
    [PSObject] GetDebugEntryContentAsync([bool] $useTargetProject, [string] $requestId, [string] $debugEntryId) {
        return $this.Request($useTargetProject, 'get', "symbol/requests/$requestId/contents/$debugEntryId", $this.apiVersion, $null)
    }
