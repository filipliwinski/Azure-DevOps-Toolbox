...
class TaskAgentApiClient : AzureDevOpsApiClient {
    ...
    [PSObject] HasPoolPermissions([bool] $useTargetProject, [int] $poolId, [int] $permissions) {
        return $this.Request($useTargetProject, 'get', "distributedtask/pools/$poolId/permissions/$permissions", $this.apiVersion, $null)
    }
