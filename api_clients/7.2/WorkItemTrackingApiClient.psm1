...
class WorkItemTrackingApiClient : AzureDevOpsApiClient {
    ...
    [PSObject] GetGithubConnections([bool] $useTargetProject) {
        return $this.Request($useTargetProject, 'get', "githubconnections", $this.apiVersion, $null)
    }

    # Gets a list of repos within specified github connection.
    [PSObject] GetGithubConnectionRepositories([bool] $useTargetProject, [string] $connectionId) {
        return $this.Request($useTargetProject, 'get', "githubconnections/$connectionId/repos", $this.apiVersion, $null)
    }

    # Add/remove list of repos within specified github connection.
    [PSObject] UpdateGithubConnectionRepos([bool] $useTargetProject, [PSObject] $body, [string] $connectionId) {
        return $this.Request($useTargetProject, 'post', "githubconnections/$connectionId/reposBatch", $this.apiVersion, $body)
    }
    ...
    [PSObject] DeleteAttachment([bool] $useTargetProject, [string] $id) {
        return $this.Request($useTargetProject, 'delete', "wit/attachments/$id", $this.apiVersion, $null)
    }
